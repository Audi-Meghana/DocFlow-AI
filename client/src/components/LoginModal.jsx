            ...
            <Dialog.Panel className="relative w-full max-w-sm overflow-hidden rounded-2xl bg-white p-5 shadow-xl border border-[#191B2E]/10">
              ...
              <div className="flex justify-between items-center mb-4">
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <h2 className="font-display text-base font-bold text-[#191B2E]">Welcome Back</h2>
                    <p className="text-[10px] text-[#5B5E70]">Sign in to DocFlow AI</p>
                  </div>
                </div>
                <button
                ...
                <div>
                  ...
                  <div className="group relative flex items-center rounded-lg border border-[#191B2E]/15 bg-[#FAFBFD] focus-within:border-[#453AA4] focus-within:bg-white">
                    ...
                    <input
                      ...
                      className="w-full bg-transparent py-2 pl-8 pr-3 text-xs text-[#191B2E] outline-none placeholder:text-[#8A8D9F]"
                ...
                <div>
                  ...
                  <div className="group relative flex items-center rounded-lg border border-[#191B2E]/15 bg-[#FAFBFD] focus-within:border-[#453AA4] focus-within:bg-white">
                    ...
                    <input
                      ...
                      name="password"
                      placeholder="••••••••"
                      className="w-full bg-transparent py-2 pl-8 pr-8 text-xs text-[#191B2E] outline-none placeholder:text-[#8A8D9F]"
              ...
              <div className="mt-4 border-t border-[#191B2E]/5 pt-3 text-center text-[11px] text-[#5B5E70]">
                Need an account?{" "}
                <button
                  type="button"
                  onClick={() => {
